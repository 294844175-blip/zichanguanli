...
CREATE TABLE "new_assets" (
    ...
    "graphic_area" REAL NOT NULL DEFAULT 0,
    "asset_area" REAL NOT NULL DEFAULT 0,
...
INSERT INTO "new_assets" ("area", "building_area", "building_id", "code", "contract_no", "created_at", "customer", "end_date", "floor_height", "floor_id", "id", "industry", "load_capacity", "name", "park_id", "passage", "phone", "projection_area", "property_fee_unit", "rentable_area", "score", "slice_height", "slice_icon", "slice_rotation", "slice_title", "slice_width", "slice_x", "slice_y", "start_date", "status", "type", "unit_price", "updated_at", "utility_fee_unit") SELECT "area", "building_area", "building_id", "code", "contract_no", "created_at", "customer", "end_date", "floor_height", "floor_id", "id", "industry", "load_capacity", "name", "park_id", "passage", "phone", "projection_area", "property_fee_unit", "rentable_area", "score", "slice_height", "slice_icon", "slice_rotation", "slice_title", "slice_width", "slice_x", "slice_y", "start_date", "status", "type", "unit_price", "updated_at", "utility_fee_unit" FROM "assets";
DROP TABLE "assets";
